...
import { cardvaritent } from '../config/Varients'

const Projects = () => {

    return (
        <section
            id='projects' className='flex mt-16 '>
            <div
                className='w-4/5 mx-auto mt-20 space-y-16'>
                ...
                <div
                    ...
                    className='w-full  flex gap-16 flex-wrap mx-auto justify-center'>
                    {
                        projects_List.map((m) => (
                            <motion.div
                                variants={cardvaritent}
                                initial="offscreen"
                                whileInView="onscreen"
                                viewport={{ once: true, amount: 0.8 }}
                                className='max-w-96 p-2 relative bg-[#0a1e29] ' key={m.id}>
